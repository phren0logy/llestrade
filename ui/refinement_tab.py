    ...
    def run(self):
        ...
        try:
            ...
            llm_client = LLMClient(
                timeout=DEFAULT_TIMEOUT * 5,  # Increased timeout for refinement (5 minutes)
                max_retries=3,
...
1. Check the report against a transcript, if provided. The transcript is wrapped in <transcript> tags. Minor changes to punctuation and capitalization or removal of words with an elipsis are OK and do not need to be changed.
...
3. Some information may not appear in the transcript, such as quotes from other documents or psychometric testing. Do not make changes to this information that does not appear in the transcript. Do make a note of it in your thinking.
