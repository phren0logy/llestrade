...
class RefinementTab(BaseTab):
    ...
    def setup_ui(self):
        ...
        default_instruction = """This draft report, wrapped in <draft> tags, is a rough draft of a forensic psychiatric report. Perform the following steps to improve the report:
        ...
        3. After making those changes, revise the document for readability. Preserve details that are important for accurate diagnosis and formulation.
        4. Check the report against a transcript, if provided. The transcript is wrapped in <transcript> tags. Minor changes to punctuation and capitalization or removal of words with an elipsis are OK and do not need to be changed. 
        5. Some information may not appear in the transcript, such as quotes from other documents or psychometric testing. Do not make changes to this information that does not appear in the transcript. Do make a note of it in your thinking.
        6. Output only the final revised report."""
