...
- [ ] Create new `llm/` directory structure
- [ ] Extract base provider class with Qt patterns
- [ ] Move provider-specific code to separate files
- [ ] Implement markdown-aware chunking with langchain-text-splitters
- [ ] Create unified token counting module
...
- [ ] Verify no imports of these libraries remain
...
- [ ] Search for imports from `docs/sample_code/`
- [ ] Check for usage of extended thinking methods
...
- [ ] Investigating unused code
- [ ] Planning Qt pattern improvements
...
*Next Review: After memory corruption fix*